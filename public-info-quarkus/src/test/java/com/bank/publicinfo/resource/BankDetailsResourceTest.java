...
class BankDetailsResourceTest {
    ...
    private void persistBank(long bik, long inn, long kpp, long cor, String city, String jsc, String name) {
        BankDetails b = new BankDetails();
        b.setBik(bik); b.setInn(inn); b.setKpp(kpp); b.setCorAccount(cor);
        b.setCity(city); b.setJointStockCompany(jsc); b.setName(name);
        b.persistAndFlush();
    }

    private String bankJson(long bik, long inn, long kpp, long cor,
                             String city, String jsc, String name) {
        return String.format(
            "{\"bik\":%d,\"inn\":%d,\"kpp\":%d,\"corAccount\":%d," +
    ...
    void getAll_withData_returnsPaged() {
        persistBank(44525225L, 7710140679L, 771001001L, 301018104000000225L, "Москва", "ПАО", "Банк А");
        persistBank(44525226L, 7710140680L, 771001002L, 301018104000000226L, "СПб",   "ОАО", "Банк Б");
    ...
    void getById_found_returns200() {
        BankDetails b = new BankDetails();
        b.setBik(44525999L); b.setInn(7710140999L); b.setKpp(771001999L);
        b.setCorAccount(301018104000000999L); b.setCity("Казань");
        b.setJointStockCompany("ПАО"); b.setName("Тест-Банк");
        b.persistAndFlush();
    ...
    void create_valid_returns201() {
        String body = bankJson(44525225L, 7710140679L, 771001001L,
                               301018104000000225L, "Москва", "ПАО", "Сбербанк");
    ...
    void update_valid_returns200() {
        BankDetails b = new BankDetails();
        b.setBik(44525300L); b.setInn(7710140300L); b.setKpp(771001300L);
        b.setCorAccount(301018104000000300L); b.setCity("Москва");
        b.setJointStockCompany("ПАО"); b.setName("Старое имя");
        b.persistAndFlush();

        String update = bankJson(44525300L, 7710140300L, 771001300L,
                                  301018104000000300L, "СПб", "ОАО", "Новое имя");
    ...
    void update_notFound_returns404() {
        String body = bankJson(44525225L, 7710140679L, 771001001L,
                               301018104000000225L, "Москва", "ПАО", "X");
        given().contentType("application/json").body(body)
    ...
    void delete_exists_returns204() {
        BankDetails b = new BankDetails();
        b.setBik(44525400L); b.setInn(7710140400L); b.setKpp(771001400L);
        b.setCorAccount(301018104000000400L); b.setCity("Москва");
        b.setJointStockCompany("ПАО"); b.setName("Удалить");
        b.persistAndFlush();
